...
clf; 
rawdatalog = '/home/nu/GNUOctave/walkingSNFjoggingSNFcylcingSNF.csv';
DM=csvread(rawdatalog); #Data Matrix
%size(DM)

datastartpoint=2000; datalength=50+it; 
...
subplot(4,4,[1:4])
plot (samples, x, colorlegendx ,'linewidth', 2,samples, y,colorlegendy, 'linewidth', 2,samples, z, colorlegendz,'linewidth', 2, samples, DATA, "k;abs();",'linewidth', 2);
 title (title_string, 'fontsize', 20);
 xlabel('sample, n'); ylabel('raw data');
# axis([datastartpoint,datastartpoint+1000, -2, 2.5])  
...
fig3d=sprintf('/home/nu/GNUOctave/walkingslow/ROT/images/output_%03d.png',it);
print(fig3d);
#print(fig3d,"-S560,420");
#print(fig3d,"-S1200,900"); # it does not work properly, there are some images which does not respect the size
