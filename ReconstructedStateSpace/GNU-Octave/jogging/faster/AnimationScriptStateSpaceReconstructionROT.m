...
datastartpoint=25000; datalength=50+it; 
...
DATAVECTOR=[8,9,10];  title_string='EULER ANGLES'; colorlegendx="b;Yaw;"; colorlegendy="g;Pitch;"; colorlegendz="r;Roll;";# ANGLE ROTATION VECTOR (yaw, pitch, roll)
...
plot (samples, x, colorlegendx ,'linewidth', 2,samples, y,colorlegendy, 'linewidth', 2,samples, z, colorlegendz,'linewidth', 2);
 ...
 axis([datastartpoint,datastartpoint+1000, -3.5 3.5])  
...
fig3d=sprintf('/home/x/octave362/joggingfaster/ROT/images/output_%03d.png',it);
